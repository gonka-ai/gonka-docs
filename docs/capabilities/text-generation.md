...
An example call to the [Chat Completions](/endpoints/chat-completions) API would look like this:
...
To learn more, you can view the [Chat Completions](endpoints/chat-completions) guide.
