...
Governance decisions are made through PoC-weighted voting, where each participant’s influence is proportional to their verified compute activity and committed collateral. Technical details, including weight activation mechanics and collateral ratios, are covered in Gonka: Tokenomics.
...
| **Veto Threshold**    | 33.4% of the entire non-abstaining voting power in the system | If the fraction of NoWithVeto votes reaches this level, the proposal is forcefully rejected regardless of other votes.                            | Acts as a safeguard against malicious or harmful proposals even if they have majority support.                        |
