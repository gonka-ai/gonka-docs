...
!!! note "Reminder" 
    Include the **entire** `params` object, not just the fields you changed. ([hub.cosmos.network](https://hub.cosmos.network/main/governance/submitting?utm_source=chatgpt.com "Submitting a Proposal - Cosmos Hub"))
