...
2. [Set up a wallet in Keplr](https://gonka.ai/wallet/dashboard#2-set-up-external-wallet)
3. [Connect to the dashboard](https://gonka.ai/wallet/dashboard#3-connect-wallet)

## Step 1. Purchase USDT (ERC-20)

1.1. In Keplr, search for Ethereum. Hover over the Copy icon and copy your Ethereum address.  
...
1.3. Select any third-party service. For demonstration purposes, this guide uses [Swapped.com](https://swapped.com/), which is not affiliated with the Gonka Network.  
...
1.5. Enter the USDT (ERC-20) address you copied from Keplr.  
...
1.6. Select Pay with Card and complete the order.  
...
1.8. After a short processing period (typically a few minutes), your updated balance will appear in Keplr.  
