...
=======
        <span class="partner-label">优选节点提供方</span>
>>>>>>> 7832026 (transfers)
=======
...
=======
        <span class="partner-label">优选AI开发者</span>
>>>>>>> 7832026 (transfers)
=======
        <span class="partner-label">精选AI开发者</span>
>>>>>>> 6addb31 (transfers)
...
>>>>>>> 7832026 (transfers)
=======
    let offset = 0;   // 当前滚动偏移量 [0, 周期)
    let period = 0;   // 一组完整卡片的宽度 (A → A')
    const speed = 72; // 像素/秒（可按需调整）
    let lastTs = null;
