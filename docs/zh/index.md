    ...
    <div class="carousel-track">
      ...
      <div class="partner-card">
        ...
        <div class="partner-logos">
          ...
          <span class="partner-label">获以下机构支持</span>
    ...
    <div class="footer-cols">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="/pow-security-analysis.pdf">基于Transformer的共识机制</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>GNK</h4>
...
+ '?from=landing';
  ...
  if (carouselTrack) {
    ...
    const speed = 72; // 像素/秒（可根据需要调整）
    let lastTs = null;

    // 确保有足够的副本 (A, A', A'', ...) 覆盖视口加一个周期
    ...
    // 使用DOM位置测量重复周期：从第一个原始元素到第一个副本的距离
