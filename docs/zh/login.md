...
<div class="login-form" style="max-width: 400px; margin: auto; padding: 20px; border: 1px solid #ccc; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    <form id="loginForm">
        <div style="margin-bottom: 20px;">
            <label for="pemail" style="display: block; font-weight: bold; margin-bottom: 5px;">邮箱：</label>
        ...
        <div style="margin-bottom: 20px;">
            <label for="password" style="display: block; font-weight: bold; margin-bottom: 5px;">密码：</label>
        ...
        <div style="text-align: center;">
            <input type="submit" value="登录" style="padding: 10px 20px; font-size: 1em; font-weight: bold; color: white; background-color: #007bff; border: none; border-radius: 5px; cursor: pointer; transition: background-color 0.3s;">
        </div>
    </form>
