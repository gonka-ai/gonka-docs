...
本页列出了模型许可证。它并未说明某个模型当前是否在Gonka上、过去是否提供过，或从未部署过。如需获取当前治理集，请查询 `GET /v1/governance/models`。
...
- [MiniMax-M2.7](https://github.com/MiniMax-AI/MiniMax-M2.7/blob/main/LICENSE)
